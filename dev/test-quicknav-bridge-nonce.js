...
const BRIDGE_SRC = fs.readFileSync(path.join(ROOT, 'content', 'aishortcuts-bridge.js'), 'utf8');
...
function runBridge({ href, nonce, now }) {
  ...
  vm.runInContext(BRIDGE_SRC, sandbox, { filename: 'content/aishortcuts-bridge.js' });
