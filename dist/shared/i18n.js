(() => {
  ...
  const EXACT_TEXT_MAP = Object.freeze({
    ...
    '对 pre/table/公式等高开销块使用 contain/content-visibility，减少卡顿。': 'Uses contain/content-visibility on expensive blocks such as pre/table/formulas to reduce jank.',
    '将动画/过渡 duration 置 0，减少合成与重绘开销；外观变化较小。': 'Sets animation/transition durations to 0 to reduce composition and repaint costs with minimal visual impact.',
    ...
    '在 chatgpt.com：⌘O 切换推理强度（Light/Heavy 或 Standard/Extended）；⌘J 在 GPT 5.2 thinking ↔ GPT 5.2 pro 之间切换。': 'On chatgpt.com, use ⌘O to switch the reasoning effort (Light/Heavy or Standard/Extended) and ⌘J to switch between GPT 5.2 Thinking and GPT 5.2 Pro.',
