...
| MR-DEV-MEMTEST | Product dev page label (`AI Shortcuts Dev`) | `dev/memtest.html:6`, `dev/memtest.html:202` | Must Rename |
| MR-DEV-SMOKE | Product dev smoke labels (`AI Shortcuts Dev`) | `dev/scroll-tests/qwen-conversation-switch-smoke.js:15`, `dev/scroll-tests/chatgpt-scroll-lock-smoke.js:187` | Must Rename |
| MR-DEV-STATS | Product dev CLI label (`AI Shortcuts MV3 stats`) | `dev/stats.js:120` | Must Rename |
...
- `dev/assert-brand-boundaries.js` enforces these rules using `dev/rename-boundary-allowlist.json`.
