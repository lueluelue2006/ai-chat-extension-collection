(() => {
  ...
  const CHATGPT_CORE_FILES = [CHATGPT_DOM_ADAPTER_FILE, CHATGPT_CORE_FILE] as const;
  const CHATGPT_CORE_MAIN_FILES = [CHATGPT_DOM_ADAPTER_FILE, CHATGPT_CORE_MAIN_FILE] as const;
